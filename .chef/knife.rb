# reference: http://knife-zero.github.io/20_getting_started/
...
# use specific key file to connect server instead of ssh_agent
# (use ssh_agent is set true by default).
